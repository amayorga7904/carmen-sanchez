...
WHERE country.continent = 'South America' AND city.name LIKE 'Serra%' AND city.name != 'Serravalle';
...
-- Write SQL query here
SELECT capital FROM country JOIN city ON capital = city.id WHERE country.code = 'BRA';
...
SELECT name FROM city WHERE population BETWEEN 91084 AND 91085;
